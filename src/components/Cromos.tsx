...
const Cromos: React.FC = () => {
  ...
  const GRUPOS = [
    ...
    { id: 'A', nombre: 'Grupo A', equipos: ['México', 'Corea del Sur', 'Sudáfrica', 'Dinamarca / Macedonia / Chequia / Irlanda'] },
    { id: 'B', nombre: 'Grupo B', equipos: ['Canadá', 'Suiza', 'Catar', 'Italia / Irlanda N. / Gales / Bosnia'] },
    { id: 'C', nombre: 'Grupo C', equipos: ['Brasil', 'Marruecos', 'Escocia', 'Haití'] },
    { id: 'D', nombre: 'Grupo D', equipos: ['Estados Unidos', 'Australia', 'Paraguay', 'Turquía / Rumanía / Eslovaquia / Kosovo'] },
    { id: 'E', nombre: 'Grupo E', equipos: ['Alemania', 'Ecuador', 'Costa de Marfil', 'Curazao'] },
    { id: 'F', nombre: 'Grupo F', equipos: ['Países Bajos', 'Japón', 'Túnez', 'Ucrania / Suecia / Polonia / Albania'] },
    { id: 'G', nombre: 'Grupo G', equipos: ['Bélgica', 'Irán', 'Egipto', 'Nueva Zelanda'] },
    { id: 'H', nombre: 'Grupo H', equipos: ['España', 'Uruguay', 'Arabia Saudí', 'Cabo Verde'] },
    { id: 'I', nombre: 'Grupo I', equipos: ['Francia', 'Senegal', 'Noruega', 'Irak / Bolivia / Surinam'] },
    { id: 'J', nombre: 'Grupo J', equipos: ['Argentina', 'Austria', 'Argelia', 'Jordania'] },
    { id: 'K', nombre: 'Grupo K', equipos: ['Portugal', 'Colombia', 'Uzbekistán', 'RD Congo / Jamaica / Nueva Caledonia'] },
    { id: 'L', nombre: 'Grupo L', equipos: ['Inglaterra', 'Croacia', 'Panamá', 'Ghana'] },
  ];
